...
### An Analytical Solution: From EDA to Model Interpretation  
**Kaggle Top 5% | RMSLE = 0.11952**

## Project Overview
This project solves the Kaggle competition **House Prices – Advanced Regression Techniques**. The goal is to predict the final sale price (`SalePrice`) of residential homes using 79 descriptive features. The evaluation metric is **RMSLE**, which penalises relative error, making it suitable for a wide price range.
